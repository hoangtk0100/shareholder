...
public class PersonController {
    ...
    public Person deactivate(@PathVariable("id") String id) throws DatabaseException {
        return personService.deactivate(id);
    }

    // Delete person
    @DeleteMapping("/delete/{id}")
    public String delete(@PathVariable("id") String id) throws DatabaseException {
    ...
    public Person retrieveById(@PathVariable("id") String id) throws NotFoundException {
        return personService.retrieveById(id);
    }

    // Retrieve specific person by username
    @GetMapping("/showByUsername/{username}")
    public Person retrieveByUsername(@PathVariable("username") String username) throws NotFoundException {
    ...
    public Person retrieveByPersonalId(@PathVariable("personalId") String personalId) throws NotFoundException {
    ...
    public Person retrieveByPhoneNumber(@PathVariable("phoneNumber") String phoneNumber) throws NotFoundException {
